...
public class PlayerBehaviour : MonoBehaviour
{
    ...
    private void _Move()
    {
        ...
        if (isGrounded)
        {
            ...
            {
                // move right
                body.velocity = playerCam.transform.right * speed*0.5f * Time.deltaTime;
            }
            ...
            {
                // move forward
                body.velocity = playerCam.transform.forward * speed * 0.5f * Time.deltaTime;
            }
            ...
            {
                body.velocity += transform.up * speed* 0.09f * Time.deltaTime;
            }
